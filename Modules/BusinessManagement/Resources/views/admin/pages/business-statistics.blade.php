                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file cmn_focus rounded-10">
                                                    <input type="file" class="upload-file__input"
                                                           accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}" name="total_download_image" tabindex="1" data-max-upload-size="{{ $maxSize }}">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
                                                        <img width="80"
                                                             src="{{ $data?->value['total_download']['image'] ? dynamicStorage('storage/app/public/business/landing-pages/business-statistics/total-download/'.$data?->value['total_download']['image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="totalDownloadCount"
                                                   ...
                                                   placeholder="{{ translate('Ex: 5') }}" required tabindex="2">
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="totalDownloadContent"
                                                   ...
                                                   placeholder="{{ translate('Ex: Download') }}" required tabindex="3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                        <div class="card-body d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file cmn_focus rounded-10">
                                                    <input type="file" class="upload-file__input"
                                                           accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}" name="complete_ride_image" tabindex="4" data-max-upload-size="{{ $maxSize }}">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
                                                        <img width="80"
                                                             src="{{ $data?->value['complete_ride']['image'] ? dynamicStorage('storage/app/public/business/landing-pages/business-statistics/complete-ride/'.$data?->value['complete_ride']['image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="completeRideContent"
                                                   ...
                                                   placeholder="{{ translate('Ex: Complete Ride') }}" required tabindex="6">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file cmn_focus rounded-10">
                                                    <input type="file" class="upload-file__input"
                                                           ...
                                                           name="happy_customer_image" tabindex="7" data-max-upload-size="{{ $maxSize }}">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
                                                        <img width="80"
                                                             src="{{ $data?->value['happy_customer']['image'] ? dynamicStorage('storage/app/public/business/landing-pages/business-statistics/happy-customer/'.$data?->value['happy_customer']['image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="happyCustomerCount"
                                                   ...
                                                   placeholder="{{ translate('Ex: 5') }}" required tabindex="8">
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="happyCustomerContent"
                                                   ...
                                                   placeholder="{{ translate('Ex: Happy Customer') }}" required tabindex="9">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                        <div class="card-body d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file cmn_focus rounded-10">
                                                    <input type="file" class="upload-file__input"
                                                           accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}" name="support_image" tabindex="10" data-max-upload-size="{{ $maxSize }}">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
                                                        <img width="80"
                                                             src="{{ $data?->value['support']['image'] ? dynamicStorage('storage/app/public/business/landing-pages/business-statistics/support/'.$data?->value['support']['image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="supportTitle"
                                                   ...
                                                   placeholder="{{ translate('Ex: Title') }}" required tabindex="11">
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="supportContent"
                                                   ...
                                                   placeholder="{{ translate('Ex: 24/7 Support') }}" required tabindex="12">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    <button class="btn btn-secondary text-uppercase cmn_focus"
                                            type="reset" tabindex="13">{{ translate('reset') }}</button>
