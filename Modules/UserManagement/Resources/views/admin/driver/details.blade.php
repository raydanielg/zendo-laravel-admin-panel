...
@section('content')
    ...
    <div class="main-content">
        @php
            $collectCash = '<a href="' . route('admin.driver.cash.index', $commonData['driver']->id)  .'" class="fw-semibold text-info" target="_blank">'. translate('Collect cash') .'</a>';
            $maximumCashInHandLimit = businessConfig('max_amount_to_hold_cash')?->value ?? 0;
        @endphp
        <div class="container-fluid">
            <div class="row d-flex align-items-center mb-3">
                <div class="col-12 {{ $commonData['collectable_amount'] >= $maximumCashInHandLimit && businessConfig('cash_in_hand_setup_status')?->value ? 'col-lg-5' : '' }}">
                    <h2 class="fs-22 w-100">{{ translate('driver') }} #{{ $commonData['driver']->id }}</h2>
                </div>
                @if($commonData['collectable_amount'] >= $maximumCashInHandLimit && businessConfig('cash_in_hand_setup_status')?->value && businessConfig('cash_in_hand_setup_status')?->value)
                    <div class="col-12 col-lg-7">
                        <div class="">
                            <div class="alert alert-danger-custom m-0" role="alert">
                                <div>
                                    <img width="16" class="pb-1" src="{{ dynamicAsset('public/assets/admin-module/img/svg/info-triangle-danger.svg') }}" alt="">
                                ...
                                <div class="media flex-wrap gap-3 gap-lg-4">
                                    <div class="avatar avatar-135 rounded">
                                        <img src="{{ onErrorImage(
                                            ...
                                            dynamicStorage('storage/app/public/driver/profile') . '/' . $commonData['driver']?->profile_image,
                                    ...
                                    <div class="media-body">
                                        <div class="d-flex flex-column align-items-start gap-1">
                                            <h6 class="mb-10">
                                                ...
                                                @if($commonData['collectable_amount'] >= $maximumCashInHandLimit && businessConfig('cash_in_hand_setup_status')?->value)
                                                    <img width="18" src="{{ dynamicAsset('public/assets/admin-module/img/svg/on-hold.svg') }}" alt="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{ translate('on_hold') }}">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card h-100 d-flex justify-content-center align-items-center">
                                <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                    <img width="48" src="{{ dynamicAsset('public/assets/admin-module/img/media/cc.png') }}"
                                        alt="">
