        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.business.setup.referral-earning.store') }}" id="business_form" method="post"
                        ...
                        <div class="card-body collapsible-card-body">
                            <div class="p-20 rounded border d-flex align-items-center justify-content-between gap-2">
                                ...
                                <label class="switcher rounded-pill cmn_focus">
                                    <input class="switcher_input collapsible-card-switcher" type="checkbox" tabindex="1"
                        ...
                        <div class="card-body collapsible-card-body">
                            <div class="p-20 rounded border d-flex align-items-center justify-content-between gap-2">
                                ...
                                <label class="switcher cmn_focus rounded-pill">
                                    <input class="switcher_input collapsible-card-switcher" type="checkbox" tabindex="8"
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="submit" class="btn btn-primary text-uppercase cmn_focus" tabindex="11">{{translate('submit')}}</button>
                </div>
            </form>
        </div>
    </div>
