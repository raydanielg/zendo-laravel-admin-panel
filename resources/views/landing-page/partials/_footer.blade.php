            ...
            <div class="footer__wrapper">
                <div class="footer__wrapper-widget">
                    <div class="cont">
                        <a href="{{ route('index') }}" class="logo">
                            <img src="{{ $footerLogo ? dynamicStorage(path: "storage/app/public/business/".$footerLogo) : dynamicAsset(path: 'public/landing-page/assets/img/logo.png') }}" alt="logo">
                        </a>
                        <p>
                            ...
                            @foreach($links as $link)
                                ...
                                <li>
                                    <a href="{{$link->link}}" target="_blank">
                                        <img src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/facebook.png') }}" alt="img">
                                    </a>
                                </li>
                                @elseif($link->name == "instagram")
                                <li>
                                    <a href="{{$link->link}}"  target="_blank">
                                        <img src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/instagram.png') }}" alt="img">
                                    </a>
                                </li>
                                @elseif($link->name == "twitter")
                                <li>
                                    <a href="{{$link->link}}"  target="_blank">
                                        <img src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/twitter.png') }}" alt="img">
                                    </a>
                                </li>
                                @elseif($link->name == "linkedin")
                                <li>
                                    <a href="{{$link->link}}"  target="_blank">
                                        <img src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/linkedin.png') }}" alt="img">
                                    </a>
                                </li>
                                @endif
                            @endforeach
                ...
                <div class="footer__wrapper-widget">
                    <div class="footer__wrapper-contact">
                        <img class="icon" src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/mail.png') }}" alt="footer">
                        <h6>
                ...
                <div class="footer__wrapper-widget">
                    <div class="footer__wrapper-contact">
                        <img class="icon" src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/tel.png') }}" alt="footer">
                        <h6>
                ...
                <div class="footer__wrapper-widget">
                    <div class="footer__wrapper-contact">
                        <img class="icon" src="{{ dynamicAsset(path: 'public/landing-page/assets/img/footer/pin.png') }}" alt="footer">
                        <h6>
                            {{ translate('Send us Mail') }}
                        </h6>
                        <div>
