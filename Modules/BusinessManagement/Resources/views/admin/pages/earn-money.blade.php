                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    <button class="btn btn-secondary text-uppercase cmn_focus" tabindex="3"
                                            type="reset">{{ translate('reset') }}</button>
                                    <button class="btn btn-primary cmn_focus text-uppercase" tabindex="4"
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.business.pages-media.landing-page.earn-money.update') }}"
                        ...
                        <div class="row">
                                ...
                                <div class="d-flex flex-column gap-3 mb-4">
                                    ...
                                    <div class="d-flex">
                                        <div class="upload-file cmn_focus rounded-10">
                                            <input type="file" class="upload-file__input" name="image" tabindex="5"
                                                   accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}" {{ $data1?->value['image'] ? '' : 'required'}} data-max-upload-size="{{ $maxSize }}">
                                            <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                            <div class="upload-file__img">
                                                <img src="{{ $data1?->value['image'] ? dynamicStorage('storage/app/public/business/landing-pages/earn-money/'.$data1?->value['image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    <button class="btn btn-primary cmn_focus text-uppercase" tabindex="6"  type="submit">{{ translate('save') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
