                                        ...
                                        <div class="col-md-12">
                                            <div class="p-30 rounded bg-F6F6F6">
                                                ...
                                                <div class="d-flex gap-3 justify-content-end">
                                                    <button
                                                        class="btn btn-light h-40px min-w-100px justify-content-center fw-semibold cmn_focus"
                                                        type="reset">{{ translate('Reset') }}</button>
                                                    <button
                                                        class="btn btn-primary h-40px min-w-100px justify-content-center fw-semibold cmn_focus">{{ translate('Submit') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
