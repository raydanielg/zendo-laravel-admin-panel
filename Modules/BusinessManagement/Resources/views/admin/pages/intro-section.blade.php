                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="character-count">
                                        <input type="text" class="form-control character-count-field"  maxlength="100" data-max-character="100"  id="title" name="title"
                                               value="{{$data?->value['title']??''}}" tabindex="1"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="character-count">
                                        <input type="text" class="form-control character-count-field"  maxlength="200" data-max-character="200"  id="subTitle" name="sub_title"
                                               value="{{$data?->value['sub_title']??''}}" tabindex="2"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex flex-column gap-3 mb-4">
                                    ...
                                    <div class="d-flex">
                                        <div class="upload-file rounded-10 cmn_focus">
                                            <input type="file" class="upload-file__input" tabindex="5" name="background_image" accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}" data-max-upload-size="{{ $maxSize }}"
                                            ...
                                            <div class="upload-file__img upload-file__img_banner aspect-ratio-3-1 overflow-hidden d-flex justify-content-center">
                                                @if($data1?->value['background_image'] && file_exists('storage/app/public/business/landing-pages/intro-section/'.$data1?->value['background_image']))
                                                    <img class="aspect-ratio-auto h-100"
                                                        src="{{ $data1?->value['background_image'] ? dynamicStorage('storage/app/public/business/landing-pages/intro-section/'.$data1?->value['background_image']):dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}"
                                                        alt="">
                                                @else
                                                    <img class="aspect-ratio-auto h-100" src="{{ dynamicAsset('public/assets/admin-module/img/media/upload-file.png') }}" alt="">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
