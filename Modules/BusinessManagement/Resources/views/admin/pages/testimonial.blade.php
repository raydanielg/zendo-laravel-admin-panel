                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    ...
                                    <button class="btn btn-primary cmn_focus text-uppercase"
                                            type="submit" tabindex="7">{{ translate('save') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
                                            ...
                                            <div class="d-flex justify-content-center w-100">
                                                <div
                                                    ...
                                                    <img class="h-100 fit-object"
                                                         src="{{ $testimonial?->value['reviewer_image'] ? dynamicStorage('storage/app/public/business/landing-pages/testimonial/'.$testimonial?->value['reviewer_image']) : dynamicAsset('public/assets/admin-module/img/media/bike.png') }}"
                                                         alt="">
                                                </div>
                                            </div>
                                        </td>
