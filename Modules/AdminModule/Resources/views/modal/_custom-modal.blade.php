            ...
            <div class="modal-body pb-5 pt-0">
                <div class="max-349 mx-auto">
                    <div>
                        <div class="text-center">
                            <img alt="" class="mb-4" id="icon"
                                 src="{{dynamicAsset('public/assets/admin-module/img/modal/zone-time-overlapping.png')}}" height="62" width="63">
                ...
                <div class="max-349 mx-auto">
                    <div>
                        <div class="text-center">
                            ...
                            <div class="swal2-icon swal2-warning swal2-animate-warning-icon d-flex"><span
                                    class="swal2-icon-text">!</span></div>
                            <h5 class="modal-title mb-3" id="titleForWalletBonusStatus">{{translate("Are you sure?")}}</h5>
                        </div>
                        <div class="text-center mb-4 pb-2">
                    ...
                    <div class="btn--container justify-content-center">
                        <button type="button" class="btn btn-secondary min-w-120" id="modalCancelBtnForWalletBonusStatus">
                            {{translate('Cancel')}}
                        </button>
