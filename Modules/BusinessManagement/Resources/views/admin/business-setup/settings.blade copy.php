                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="">
                                            ...
                                            <div class="input-group_tooltip">
                                                <input type="number" name="pagination_limit" tabindex="12" 
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="border rounded cmn_focus rounded border-primary-light px-4 py-3 d-flex justify-content-between">
                                            ...
                                            <div class="position-relative">
                                                <label class="switcher">
                                                    <input class="switcher_input" type="checkbox" name="bid_on_fare"
                                                           id="loyalty_point_switch" tabindex="13"
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary text-capitalize cmn_focus" tabindex="14">
