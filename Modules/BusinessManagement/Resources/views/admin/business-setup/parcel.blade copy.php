            ...
            <div class="card mb-3 text-capitalize">
                <form action="{{ route('admin.business.setup.parcel.store') . '?type=' . PARCEL_SETTINGS }}"
                    ...
                    <div class="collapsible-card-body">
                        <div class="card-header d-flex align-items-center justify-content-between gap-2">
                            <div class="w-0 flex-grow-1">
                                <h5 class="mb-2">{{ translate('Parcel Return Setup ') }}</h5>
                                <div class="fs-12">
                                    {{ translate('Turn ON to enable parcel return time and late penalty.') }} {{ translate('Turn OFF to disable') }}
                                </div>
                            </div>
                        ...
                        <div class="card-body collapsible-card-content">
                            <div>
                                        ...
                                        <div
                                            ...
                                            <div class="position-relative">
                                                <i class="bi bi-info-circle-fill text-primary cursor-pointer"
                                                   data-bs-toggle="tooltip"
                                                   data-bs-title="{{ translate('If checked, customers will not pay a return fee when the driver cancels after the trip has started.')  }}">
                                                </i>
                                            </div>
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="submit"
                                            class="btn btn-primary text-uppercase cmn_focus" tabindex="9">{{ translate('submit') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.business.setup.parcel.store-parcel-weight-unit') }}"
                                ...
                                <div class="d-flex gap-3 flex-wrap justify-content-end mt-4">
                                    <button type="submit"
                                            class="btn btn-primary text-uppercase cmn_focus" tabindex="11">{{ translate('submit') }}</button>
                                </div>
                            </form>
                            ...
                            <div class="collapsible-card-body">
                                ...
                                <div class="card-body collapsible-card-content">
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-end mt-4">
                                            <button type="submit"
                                                    class="btn btn-primary text-uppercase cmn_focus" tabindex="14" {{ ($settings->firstWhere('key_name', 'max_parcel_weight_status')->value ?? 0) == 1 ? '' : 'disabled' }}>{{ translate('submit') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gy-3 pt-3 align-items-start">
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-3 flex-wrap justify-content-end">
                                    <button type="submit"
                                            class="btn btn-primary text-uppercase cmn_focus" tabindex="18">{{ translate('submit') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
