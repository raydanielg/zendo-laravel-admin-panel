                        ...
                        @can('business_edit')
                            <div class="card mb-3">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex flex-md-nowrap flex-wrap align-items-center justify-content-between gap-3 p-4">
                                        ...
                                        <label class="max-w300 w-100 form-control rounded d-flex align-items-center justify-content-between">
                                            <label for="maintenance-mode-input" class="fs-14 lh-1 d-block cursor-pointer text-dark">{{ translate('Maintenance mode') }}</label>
                                            <label class="switcher cmn_focus rounded-pill">
                                                <input data-url="{{ route('admin.business.setup.info.maintenance') }}"
                                                    ...
                                                    class="switcher_input toggle-switch-input collapsible-card-switcher {{ $config == 0 ? 'maintenance-mode-show' : 'maintenance-off' }}" tabindex="1"
                                                    {{ $config ? 'checked' : '' }}
                                    ...
                                    <div class="col-xl-8">
                                        <div class="p-lg-4 p-3 rounded bg-F6F6F6">
                                            <div class="row g-4">
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="business_name" class="mb-2">
                                                            {{ translate('business_name') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text" name="business_name"
                                                            ...
                                                            placeholder="{{ translate('Ex: ABC Company') }}" tabindex="2">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="business_contact_num" class="mb-2">
                                                            {{ translate('contact_Phone') }} <span class="text-danger">*</span>
                                                        </label>
                                                        ...
                                                        >
                                                            <input type="hidden" id="business_contact_num-hidden-element" name="business_contact_phone" tabindex="4">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="business_email" class="mb-2">
                                                            {{ translate('contact_email') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="email" name="business_contact_email"
                                                            ...
                                                            placeholder="{{ translate('Ex: company@email.com') }}" tabindex="5">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="business_support_number" class="mb-2">
                                                            {{ translate('Support_Phone') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="tel" pattern="[0-9]{1,14}" name=""
                                                               ...
                                                               oninput="this.setCustomValidity('')"
                                                        >
                                                           <input type="hidden" id="business_support_number-hidden-element" name="business_support_phone" tabindex="7">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="business_support_email" class="mb-2">
                                                            {{ translate('Support_email') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text" name="business_support_email"
                                                           ...
                                                           placeholder="{{ translate('Ex: support@email.com') }}" tabindex="8">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <select name="country_code" id="country" class="form-control js-select cmn_focus" required tabindex="9">
                                                ...
                                                <div class="col-12">
                                                    <label for="business_address" class="mb-2">{{ translate('business_address') }} <span class="text-danger">*</span></label>
                                                    <div class="character-count">
                                                        <textarea name="business_address" id="business_address" cols="30" rows="4"
                                                                ...
                                                                placeholder="{{ translate('Type Here ...') }}" maxlength="100" data-max-character="100" tabindex="10">{{ $settings->firstWhere('key_name', 'business_address')?->value ?? old('business_address') }}</textarea>
                                                        <span
                                ...
                                <div class="row g-3">
                                                ...
                                                <div class="col-lg-4">
                                                    <div>
                                                        <label for="time_zone" class="mb-2">
                                                            {{ translate('Time_Zone') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <select name="time_zone" id="time_zone" class="form-control js-select cmn_focus" tabindex="12">
                                                            <option value="" disabled selected>
                                                ...
                                                <div class="col-lg-4">
                                                    <div>
                                                        <label for="time_format" class="mb-2">
                                                            {{ translate('Time_Format') }} <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="d-flex align-items-center form-control cmn_focus rounded">
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <label for="time_format_left"
                                                                    ...
                                                                    <span class="media-body">{{ translate('12_hours') }}</span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <label for="time_format_right"
                                                                    class="media gap-2 align-items-center">
                                                                    <span class="media-body">{{ translate('24_hours') }}</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row g-4">
                                                <div class="col-lg-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="currency_code" id="currency" class="form-control js-select cmn_focus" tabindex="15">
                                                ...
                                                <div class="col-lg-4">
                                                    <div>
                                                        <label for="currency_position" class="mb-2">
                                                            {{ translate('Currency_symbol_position') }} <span class="text-danger">*</span>
                                                            <i class="bi bi-info-circle-fill text-primary cursor-pointer"
                                                                data-bs-toggle="tooltip"
                                                                title="{{translate('select_the_currency_symbol_position_(left:_$99,_right:_99$).')}}"></i>
                                                        </label>
                                                        <select name="currency_symbol_position" id="currency_position" class="form-control js-select cmn_focus" tabindex="16">
                                                            <option disabled selected>{{ translate('select_currency_symbol_position') }}</option>
                                                            <option value="left" {{ ($settings->firstWhere('key_name', 'currency_symbol_position')?->value ?? '') == 'left' ? 'selected' : '' }}>
                                                                ($) {{ translate('left') }}
                                                            </option>
                                                            <option value="right" {{ ($settings->where('key_name', 'currency_symbol_position')->first()->value ?? '') == 'right' ? 'selected' : '' }}>
                                                                {{ translate('right') }} ($)
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div>
                                                        <label for="time_format" class="mb-2">
                                                            {{ translate('Digit_after_decimal_point') }} <span class="text-danger">*</span>
                                                        </label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="p-lg-4 p-3 rounded bg-F6F6F6 flex-grow-1">
                                                ...
                                                <div class="character-count">
                                                    <textarea name="copyright_text" id="copyright_text" cols="30" rows="1"
                                                            ...
                                                            placeholder="{{ translate('Copyright@email.com') }}" maxlength="100" data-max-character="100" tabindex="19">{{ $settings->firstWhere('key_name', 'copyright_text')?->value ?? old('copyright_text') }}</textarea>
                                                    <span
                                                        class="d-flex justify-content-end">{{ translate('0/100') }}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="p-lg-4 p-3 rounded bg-F6F6F6">
                                            <div class="row g-3">
                                                <div class="col-sm-6 col-md-4 col-xxl-2">
                                                    <div class="bg-white border rounded p-2 d-flex justify-content-between align-items-center gap-2 h-100 form-group mb-0">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-20">
                                            ...
                                            <p class="mb-0">{{ translate('Supported Formats: .png') }} ({{ translate('for loading .gif only') }}). {{ translate(key: 'Max_Size: {maxSize}', replace: ['maxSize' => readableUploadMaxFileSize('image')]) }}</p>
                                        </div>
                                        <div class="p-lg-4 p-3 rounded bg-F6F6F6">
                                            <div class="row gy-4">
                                                <div class="col-lg-6 col-xl-3">
                                                    <div class="image-upload-card bg-white card card-body px-4 py-3 h-100" id="header-logo-card">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="d-flex justify-content-center">
                                                                <div class="upload-file auto cmn_focus rounded-10 max-w-100">
                                                                    <input type="file" name="header_logo"
                                                                        class="upload-file__input"
                                                                        accept=".png" tabindex="26" data-max-upload-size="{{ readableUploadMaxFileSize('image') }}">
                                                                    <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="upload-file__textbox text-center">
                                                                            <img width="34" height="34"
                                                                                ...
                                                                                alt="" class="svg">
                                                                            <div class="mt-2 fw-medium fs-10 text-info {{ $settings?->firstWhere('key_name', 'header_logo')?->value ? 'd-none' : '' }}">
                                                                                {{ translate('Add_Image') }}
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-xl-3">
                                                    <div class="image-upload-card bg-white card card-body px-4 py-3 h-100" id="favicon-card">
                                                        <div class="text-center">
                                                            <div class="mb-4">
                                                                <label for="" class="fw-medium mb-2">
                                                            ...
                                                            <div class="d-flex justify-content-center">
                                                                <div class="upload-file auto cmn_focus rounded-10 max-w-100">
                                                                    <input type="file" name="favicon"
                                                                        class="upload-file__input"
                                                                        accept=".png" tabindex="27" data-max-upload-size="{{ readableUploadMaxFileSize('image') }}">
                                                                    <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="upload-file__textbox text-center">
                                                                            <img width="34" height="34"
                                                                                ...
                                                                                alt="" class="svg">
                                                                            <div class="mt-2 fw-medium fs-10 text-info {{ $settings?->firstWhere('key_name', 'favicon')?->value ? 'd-none' : '' }}">
                                                                                {{ translate('Add_Image') }}
                                                                            </div>
                                                                        </div>
                                                                        <img class="upload-file__img__img" loading="lazy"
                                                ...
                                                <div class="col-lg-6 col-xl-3">
                                                    <div class="image-upload-card bg-white card card-body px-4 py-3 h-100" id="footer-logo-card">
                                                        <div class="text-center">
                                                            <div class="mb-4">
                                                                <label for="" class="fw-medium mb-2">
                                                            ...
                                                            <div class="d-flex justify-content-center">
                                                                <div class="upload-file auto cmn_focus rounded-10 max-w-100">
                                                                    <input type="file" name="footer_logo"
                                                                        class="upload-file__input"
                                                                        accept=".png" tabindex="28" data-max-upload-size="{{ readableUploadMaxFileSize('image') }}">
                                                                    <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="upload-file__textbox text-center">
                                                                            <img width="34" height="34"
                                                                                ...
                                                                                alt="" class="svg">
                                                                            <div class="mt-2 fw-medium fs-10 text-info {{ $settings?->firstWhere('key_name', 'footer_logo')?->value ? 'd-none' : '' }}">
                                                                                {{ translate('Add_Image') }}
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-xl-3">
                                                    <div class="image-upload-card bg-white card card-body px-4 py-3 h-100" id="preloader-card">
                                                        <div class="text-center">
                                                            <div class="mb-4">
                                                                <label for="" class="fw-medium mb-2">
                                                            ...
                                                            <div class="d-flex justify-content-center">
                                                                <div class="upload-file auto cmn_focus rounded-10 max-w-100">
                                                                    <input type="file" name="preloader"
                                                                        class="upload-file__input" accept=".gif" tabindex="29" data-max-upload-size="{{ readableUploadMaxFileSize('image') }}">
                                                                    <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="upload-file__textbox text-center">
                                                                            <img width="34" height="34"
                                                                                ...
                                                                                alt="" class="svg">
                                                                            <div class="mt-2 fw-medium fs-10 text-info {{ $settings?->firstWhere('key_name', 'preloader')?->value ? 'd-none' : '' }}" >
                                                                                {{ translate('Add_Image') }}
                                                                            </div>
                                                                        </div>
                                                                        <img class="upload-file__img__img" loading="lazy"
            ...
            <div class="footer-sticky">
                <div class="container-fluid">
                    <div class="btn--container justify-content-end py-4">
                        <button type="submit" class="btn btn-primary text-capitalize cmn_focus" tabindex="30">{{ translate('save_information') }}</button>
                    </div>
                </div>
            </div>
        </form>
